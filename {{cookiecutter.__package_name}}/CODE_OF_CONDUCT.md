...
Notification should be done by contacting a staff person on site or by emailing {{ cookiecutter.author_name }} at
 [{{ cookiecutter.author_email }}](mailto:{{ cookiecutter.author_email }}?subject=%20Code%20of%20Conduct%20Report).
